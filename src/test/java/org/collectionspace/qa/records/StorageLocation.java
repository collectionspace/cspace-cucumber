...
public class StorageLocation extends Record {
    ...
    public StorageLocation() {
        ...
        dropDownMap.put("Term Type",    "csc-locationAuthority-termType");
        dropDownMap.put("Term Status",  "csc-locationAuthority-termStatus");
        dropDownMap.put("Language",     "csc-locationAuthority-termLanguage");
        fieldSelectorByLabel.put("Earliest Modified Date", "csc-location-updatedAtStart");
        fieldSelectorByLabel.put("Record last modified by", "csc-location-updatedBy");
